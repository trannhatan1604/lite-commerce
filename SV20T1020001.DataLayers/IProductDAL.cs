...
namespace SV20T1020001.DataLayers
{
    public interface IProductDAL
    {
        ...
        /// <param name="maxPrice">Mức giá lớn nhất trong khoảng cần tìm</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Kiểm tra xem mặt hàng hiện có đơn hàng liên quanhay không?
        /// </summary>
        /// <param name="productID"></param>
        /// <returns></returns>
        bool InUsed(int productID);
        /// <summary>
        /// Lấy danh sách của mặt hàng (sắp xếp theo thứ tự của DisplayOrder)
        /// </summary>
        /// <param name="productID"></param>
        /// <returns></returns>
